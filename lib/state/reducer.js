...
var _moveToBestDroppable = require('./move-to-best-droppable/');

var _moveToBestDroppable2 = _interopRequireDefault(_moveToBestDroppable);
...
exports.default = function () {
  ...
  if (action.type === 'CROSS_AXIS_MOVE_FORWARD' || action.type === 'CROSS_AXIS_MOVE_BACKWARD') {
    ...
    var _result = (0, _moveToBestDroppable2.default)({
    ...
    return move({
      state: state,
      clientSelection: _result.center,
      pageSelection: _result.center,
  ...
  if (action.type === 'DROP_ANIMATE') {
    var _action$payload4 = action.payload,
        ...
        _result2 = _action$payload4.result;
